...
{
public:
    void Free(void* Original) { static void (*FreeOG)(void* Original) = decltype(FreeOG)(uintptr_t(GetModuleHandle(0)) + 0x1233210); return FreeOG(Original); };
    void* Realloc(void* Original, __int64 Count, uint32_t Alignment) { static void* (*ReallocOG)(void* Original, __int64 Count, uint32_t Alignment) = decltype(ReallocOG)(uintptr_t(GetModuleHandle(0)) + 0x123E4C0); return ReallocOG(Original, Count, Alignment); };
};
...
public: \
    static constexpr std::ptrdiff_t Name##_Offset = Offset; \
    Type Get##Name() const { return *reinterpret_cast<Type*>(reinterpret_cast<uintptr_t>(this) + Name##_Offset); } \
    void Set##Name(Type value) { *reinterpret_cast<Type*>(reinterpret_cast<uintptr_t>(this) + Name##_Offset) = value; } \
public: \
